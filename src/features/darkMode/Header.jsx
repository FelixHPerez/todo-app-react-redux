  ...
  return (
    <header className="fixed top-0 z-10 flex w-full min-w-min items-center justify-between border-b border-slate-900/10 px-4 py-2 backdrop-blur-md dark:border-slate-50/[0.06]">
      ...
      <Switch
        ...
        className="hover:bg-slate relative flex h-10 w-20 items-center justify-around rounded-2xl transition-[background-color] duration-300 hocus:bg-slate-600/40"
      ...
      >
        ...
        <div className="transition-[background-color, transform] absolute left-0 -z-40 h-8 w-8 translate-x-[2px] rounded-full bg-yellow-300 duration-500 dark:translate-x-[46.2px] dark:bg-stone-300"></div>
